...
class ConditionSolver:
        ...
        # Return lvalue and rvalue of an expression of the form lvalue <operation> rvalue
        def _parse_expr(self, cond: str, operation: str):
            op_idx = cond.index(operation)
            
            return cond[:op_idx], cond[op_idx+len(operation):]
        
        # Convert a value into part of a constraint
        # e.g. uint8(84) & 128 will be converted into self.flag[84] & 128
